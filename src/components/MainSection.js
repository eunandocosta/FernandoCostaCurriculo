...
<p style={{'color': '#affc41'}}>Obrigado por visitar meu portfólio digital e espero que você goste do que vê!</p>
      ...
      <div className='flex center flexCol spaceEvenly'>
        ...
        <div className='box flex center shadow'>
          <a href='https://www.linkedin.com/in/fmscosta/' target="_blank" rel='noreferrer'><img src={LIn} alt='Linkedin Icon provided: https://icons8.com/' id='icons'/></a>
          <a href='https://www.tiktok.com/@codetools' target="_blank" rel='noreferrer'><img src={tiktok} alt='Tiktok Icon provided: https://icons8.com/' id='icons'/></a>
          <a href='https://github.com/eunandocosta' target="_blank" rel='noreferrer'><img src={github} alt='GitHub Icon provided: https://icons8.com/' id='icons'/></a>
        </div>
      </div>
    </div>
    </section>
